...
/**
	 ...
	 * @see cn.edu.scau.cmi.wuweijie.entity.server.Staff
...
public class StaffDAO  {
    ...
    public Staff findById( java.lang.Long id) {
        ...
        try {
            Staff instance = (Staff) getCurrentSession()
                    .get("cn.edu.scau.cmi.wuweijie.entity.server.Staff", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Staff> findByExample(Staff instance) {
        ...
        try {
            List<Staff> results = (List<Staff>) getCurrentSession() .createCriteria("cn.edu.scau.cmi.wuweijie.entity.server.Staff").add( create(instance) ).list();
	...
	public List<Staff> findByDuty(Object duty
	) {
		return findByProperty(DUTY, duty
		);
	}
	
	public List<Staff> findByToken(Object token
	) {
		return findByProperty(TOKEN, token
		);
	}
	
	public List<Staff> findByType(Object type
	) {
		return findByProperty(TYPE, type
		);
	}
	
	public List<Staff> findByStatus(Object status
	) {
	...
	public List<Staff> findByLoginname(Object loginname
	) {
	...
	public List<Staff> findByRemark(Object remark
	) {
    ...
    public Staff merge(Staff detachedInstance) {
        ...
        try {
            Staff result = (Staff) getCurrentSession()
